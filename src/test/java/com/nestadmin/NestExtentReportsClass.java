...
public class NestExtentReportsClass {
	...
	public void verifyLogo() {
		...
		boolean img = driver.findElement(By.xpath("//img[@class='lnXdpd' and @alt='Google']")).isDisplayed();
	...
	@Test(enabled = true)
	public void verifyNestLogin() throws InterruptedException {
		...
		// wait.until(ExpectedConditions.titleIs("Software Testing Material - A site for
		// Software Testers"));
